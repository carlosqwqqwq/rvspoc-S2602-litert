...
void MatrixBatchVectorMultiplyAccumulate(const float* matrix, int m_rows,
  ...
  RVV_OR_NEON_OR_PORTABLE(MatrixBatchVectorMultiplyAccumulate, matrix, m_rows,
                          m_cols, vector, n_batch, result);
}
...
void MatrixBatchVectorMultiplyAccumulate(const int8_t* __restrict__ matrix,
  ...
  RVV_OR_NEON_OR_PORTABLE(MatrixBatchVectorMultiplyAccumulate, matrix, m_rows,
                          m_cols, vectors, scaling_factors, n_batch, scratch,
                          result, context);
}
...
void MatrixBatchVectorMultiplyAccumulate(
  ...
  RVV_OR_NEON_OR_PORTABLE(
      MatrixBatchVectorMultiplyAccumulate, matrix, m_rows, m_cols, vectors,
      scaling_factors, n_batch, result, per_channel_scale, input_offset, scratch,
...
void SparseMatrixBatchVectorMultiplyAccumulate1x4(
  ...
  RVV_OR_NEON_OR_PORTABLE(SparseMatrixBatchVectorMultiplyAccumulate1x4, matrix,
                          segments, indices, m_rows, m_cols, vector, n_batch,
                          result);
}
...
void SparseMatrixBatchVectorMultiplyAccumulate(
    ...
    float* __restrict__ result) {
  RVV_OR_NEON_OR_PORTABLE(SparseMatrixBatchVectorMultiplyAccumulate, matrix,
                          ledger, m_rows, m_cols, vector, n_batch, result);
}
...
void SparseMatrixBatchVectorMultiplyAccumulate1x16(
  ...
  RVV_OR_NEON_OR_PORTABLE(SparseMatrixBatchVectorMultiplyAccumulate1x16,
                          matrix, segments, indices, m_rows, m_cols, vector,
                          bias_vector, n_batch, input_offset,
                          output_multiplier, output_shift, per_channel_scale,
                          per_channel_shift, output_offset,
...
void SparseMatrixBatchVectorMultiplyAccumulate(
  ...
  RVV_OR_NEON_OR_PORTABLE(SparseMatrixBatchVectorMultiplyAccumulate, matrix,
                          ledger, m_rows, m_cols, vectors, scaling_factors,
                          n_batch, result, per_channel_scale);
}
...
void MatrixBatchVectorMultiplyAccumulate(
  ...
  RVV_OR_NEON_OR_PORTABLE(MatrixBatchVectorMultiplyAccumulate, input, bias,
                          input_to_gate_weights, multiplier, shift, n_batch,
                          n_input, n_output, output_zp, scratch, output,
                          context);
}
...
void MatrixScalarMultiplyAccumulate(const int8_t* matrix, int32_t scalar,
                                    ...
                                    int32_t* output) {
  RVV_OR_NEON_OR_PORTABLE(MatrixScalarMultiplyAccumulate, matrix, scalar,
                          n_row, n_col, output);
}
...
void ApplyLayerNorm(const int16_t* input, const int16_t* layer_norm_weights,
  ...
  RVV_OR_NEON_OR_PORTABLE(ApplyLayerNorm, input, layer_norm_weights, bias,
                          layer_norm_scale_a, layer_norm_scale_b,
                          variance_limit, n_batch, n_input, output);
}
...
void ApplySigmoid(const int16_t* input, int32_t n_batch, int32_t n_input,
                  int16_t* output) {
  RVV_OR_NEON_OR_PORTABLE(ApplySigmoid, input, n_batch, n_input, output);
}
...
void ApplyTanh(int32_t integer_bits, const int16_t* input, int32_t n_batch,
  ...
  RVV_OR_NEON_OR_PORTABLE(ApplyTanh, integer_bits, input, n_batch, n_input,
                          output);
}
...
void CwiseMul(const int16_t* input_1, const int16_t* input_2, int n_batch,
  ...
  RVV_OR_NEON_OR_PORTABLE(CwiseMul, input_1, input_2, n_batch, n_input, shift,
                          output);
}
...
void CwiseMul(const int16_t* input_1, const int16_t* input_2,
  ...
  RVV_OR_NEON_OR_PORTABLE(CwiseMul, input_1, input_2, multiplier, shift,
                          n_batch, n_input, output_zp, output);
}

void CwiseAdd(const int16_t* input_1, const int16_t* input_2, int n_batch,
              int n_input, int16_t* output) {
  RVV_OR_NEON_OR_PORTABLE(CwiseAdd, input_1, input_2, n_batch, n_input,
                          output);
}

void CwiseClipping(float* vector, const int v_size,
                   const float clipping_value) {
  RVV_OR_NEON_OR_PORTABLE(CwiseClipping, vector, v_size, clipping_value);
}
...
void VectorBatchVectorCwiseProductAccumulate(const int16_t* vector, int v_size,
  ...
  RVV_OR_NEON_OR_PORTABLE(VectorBatchVectorCwiseProductAccumulate, vector,
                          v_size, batch_vector, n_batch, multiplier, shift,
                          result);
}

float VectorVectorDotProduct(const float* vector1, const float* vector2,
                             int v_size) {
  return RVV_OR_NEON_OR_PORTABLE(VectorVectorDotProduct, vector1, vector2,
                                 v_size);
}

void Sub1Vector(const float* vector, int v_size, float* result) {
  RVV_OR_NEON_OR_PORTABLE(Sub1Vector, vector, v_size, result);
}
...
bool IsZeroVector(const float* vector, int v_size) {
  return RVV_OR_NEON_OR_PORTABLE(IsZeroVector, vector, v_size);
}
...
void VectorScalarMultiply(const int8_t* vector, int v_size, float scale,
                          float* result) {
  RVV_OR_NEON_OR_PORTABLE(VectorScalarMultiply, vector, v_size, scale, result);
}

void SymmetricQuantizeFloats(const float* values, const int size,
                             int8_t* quantized_values, float* min_value,
                             float* max_value, float* scaling_factor) {
  RVV_OR_NEON_OR_PORTABLE(SymmetricQuantizeFloats, values, size,
                          quantized_values, min_value, max_value,
                          scaling_factor);
}
...
void AsymmetricQuantizeFloats(const float* values, const int size,
                              ...
                              int32_t* offset) {
  RVV_OR_NEON_OR_PORTABLE(AsymmetricQuantizeFloats, values, size,
                          quantized_values, scaling_factor, offset);
}

void ReductionSumVector(const float* input_vector, float* output_vector,
                        int output_size, int reduction_size) {
  RVV_OR_NEON_OR_PORTABLE(ReductionSumVector, input_vector, output_vector,
...
void MeanStddevNormalization(const float* __restrict__ input_vector,
                             ...
                             int n_batch) {
  RVV_OR_NEON_OR_PORTABLE(MeanStddevNormalization, input_vector, output_vector,
                          v_size, n_batch);
}
